    ...
    return (
      <>
        ...
        <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-16 py-16 md:py-24">
          <h1 className="text-[40px] md:text-[56px] text-white tracking-[-0.03em] font-medium mb-8">
            Your Cart
          </h1>
          <div className="bg-[#0a0a0f] border border-[rgba(255,255,255,0.08)] rounded-[4px] p-12 text-center">
            <svg className="w-16 h-16 mx-auto mb-6 text-[rgba(255,255,255,0.3)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
            </svg>
            <h2 className="text-[24px] text-white font-medium mb-3">Your cart is empty</h2>
            <p className="text-[16px] text-[rgba(255,255,255,0.6)] mb-8 font-light">
              Discover our latest drops and exclusive pieces
            </p>
            <Link
              href="/shop"
              className="inline-block bg-white hover:bg-[rgba(255,255,255,0.9)] transition-colors rounded-sm px-8 py-4 text-[13px] text-[#050507] uppercase tracking-[0.12em] font-medium"
            >
              Continue Shopping
            </Link>
          </div>
    ...
    <>
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-16 py-16 md:py-24">
        <div className="flex items-center justify-between mb-12">
          <h1 className="text-[40px] md:text-[56px] text-white tracking-[-0.03em] font-medium">
            Your Cart
          </h1>
          <button
            onClick={clearCart}
              ...
              >
                <div className="flex gap-6">
                  ...
                  <Link
                    ...
                    className="flex-shrink-0 w-32 h-32 rounded-[4px] overflow-hidden border border-[rgba(255,255,255,0.08)] hover:border-[rgba(255,255,255,0.15)] transition-all"
                  >
                    <img
            ...
            <div className="bg-[#0a0a0f] border border-[rgba(255,255,255,0.08)] rounded-[4px] p-6 sticky top-24">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex justify-between text-[15px]">
                  <span className="text-[rgba(255,255,255,0.6)] font-light">Items ({totalItems})</span>
                  <span className="text-white font-medium">${totalPrice.toFixed(2)}</span>
                </div>
                <div className="flex justify-between text-[15px]">
                  <span className="text-[rgba(255,255,255,0.6)] font-light">Shipping</span>
              ...
              <div className="border-t border-[rgba(255,255,255,0.08)] pt-4 mb-6">
                <div className="flex justify-between">
                  <span className="text-[18px] text-white font-medium uppercase tracking-[0.08em]">Total</span>
