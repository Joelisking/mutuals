...
export default function NewsletterSection() {
  ...
  return (
    <section className="bg-[#050507] border-t border-white/8">
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 py-16 md:py-20">
        <div className="text-center max-w-3xl mx-auto">
          <div className="bg-white/5 border border-white/10 rounded-sm px-4 py-2 inline-flex items-center gap-2 mb-6">
            <span className="text-xs text-white uppercase tracking-[0.12em] font-medium">Stay Connected</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-2xl mx-auto">
            ...
            />
            <button type="submit" className="bg-white hover:bg-white/90 transition-colors rounded-sm px-8 py-3.5 text-sm text-[#050507] uppercase tracking-[0.12em] font-medium whitespace-nowrap flex items-center justify-center gap-2">
              Subscribe
            </button>
          </form>
        </div>
